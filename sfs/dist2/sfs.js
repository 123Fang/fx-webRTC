...
(function() {
  ...
  function mb(a, b, c, d) {
    ...
    b = b ? b : new c();
    a = kb(a);
    void 0 != d ? (f.splice(d, 0, b), a.splice(d, 0, nb(b))) : (f.push(b), a.push(nb(b)));
  }
...
function sfs() {
  let selfieSegmentation = new selfie_segmentation.SelfieSegmentation({
    locateFile: (file) => {
      console.log(file);
      return `http://120.78.136.2/cdn/${file}`;
    }
  });
