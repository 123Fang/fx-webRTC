...
<template>
  <div class="container">
      ...
      <el-col :span="24">
        ...
        <el-row>
          ...
          <!-- eslint-disable-next-line-->>
            <div v-if="formInline.userId !== item.userId" :id="item.userId" v-for="(item, index) in roomUserList"
              :ref="item.userId" :key="item.userId">
              <label>
                {{ item.nickname }}
    ...
    <el-dialog :visible.sync="centerDialogVisible" :close-on-click-modal="false" :close-on-press-escape="false"
      :show-close="false" fullscreen center>
